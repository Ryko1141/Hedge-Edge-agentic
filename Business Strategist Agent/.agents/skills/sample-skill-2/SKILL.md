...
## Objective
This is a second demonstration skill showing the proper Agent Skills format. It serves as a reference for creating new skills within the ASE (Agent-Skill-Execution) framework.
